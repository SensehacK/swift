...
class LoginViewController: UIViewController {
    ...
    fileprivate func getRequestToken() {
        ...
        let request = URLRequest(url: TMDBClient.tmdbURLFromParameters(parameters: methodParameters as [String : AnyObject], withPathExtension: TMDBClient.Methods.AuthenticationTokenNew))
        
        /* 4. Make the request */
        let task = tmdbClient.session.dataTask(with: request, completionHandler: { (data, response, error) in
    ...
    fileprivate func getSessionID(_ requestToken: String) {
        ...
        /* 2/3. Build the URL, Configure the request */
        let request = URLRequest(url: TMDBClient.tmdbURLFromParameters(parameters: methodParameters as [String : AnyObject], withPathExtension: TMDBClient.Methods.AuthenticationSessionNew))
    ...
    fileprivate func getUserID(_ sessionID: String) {
        ...
        /* 2/3. Build the URL, Configure the request */
        let request = URLRequest(url: TMDBClient.tmdbURLFromParameters(parameters: methodParameters as [String : AnyObject], withPathExtension: TMDBClient.Methods.Account))
