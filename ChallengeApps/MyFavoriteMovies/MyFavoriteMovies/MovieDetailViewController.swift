...
class MovieDetailViewController: UIViewController {
    ...
    @IBAction func toggleFavorite(sender: AnyObject) {
        ...
        let task = appDelegate.sharedSession.dataTaskWithRequest(request) { (data , response , error) in
            ...
            guard error == nil else {
                displayError("Error was present Not nil")
                return
            }
            ...
            do {
               ...
               parsedResult = try NSJSONSerialization.JSONObjectWithData(data, options: .AllowFragments) as! [String : AnyObject]
                ...
                displayError("Error catched in NSJSON Serialization")
                return
            ...
            guard let tmdbStatusCode = parsedResult[Constants.TMDBResponseKeys.StatusCode] as? Int else {
                print("couldnt find TMDB status code ")
                return
            }
            ...
            {
                print("unrecognised as should favourite code should be 13 as it is unfavorited.")
                return
            }
